...
<div class="image-text-list" style="--image-width: 5em;">
  ...
  <div class="text-wrap">
    <p>
      Alteration spells, associated with the element of Earth, distort reality on a localised scale through the direct imposition of the sorcerer’s will, turning things into what they could be by convincing the earth bones that the suggested reality is easier to follow than what is already there.
    </p>
  </div>

  <div class="image-wrap">
    <img src="/images/conjuration.webp" alt="Conjuration">
  </div>
  <div class="text-wrap">
    <p>
      Conjuration spells, associated with the element of Water, pierce the liminal barriers that separate this world from the next, calling forth energies, substances, and even entities from beyond, and bind them to the sorcerer's will. The grim art of necromancy also falls under the purview of this college.
    </p>
  </div>
  ...
  <div class="text-wrap">
    <p>
      Evocation spells, associated with the element of Fire, summon energies <i>ex nihilo</i>, creating something out of nothing. Although the phenomena produced are usually transient, their consequences are real and can be extremely dangerous.
    </p>
  </div>
  ...
  <div class="text-wrap">
    <p>
      Illusion spells, associated with the element of Air, alter sensations and thoughts. They cause people to perceive things that are not there and to miss things that are. They can even make people remember things that never happened and to forget things that did.
    </p>
  </div>
  ...
  <div class="text-wrap">
    <p>
      Mysticism spells, associated with a supposed sixth element, which is surrounded by a multitude of conflicting views, exploit the principles of sympathy and contagion: as above, so below. This enables a sorcerer not only to scry remote places, but to even teleport there.
    </p>
  </div>
  ...
  <div class="text-wrap">
    <p>
      Restoration spells, associated with the element of Wood, are best known for healing wounds, curing diseases and fortifying the body to protect it from malign influences. However, these spells can also augment the abilities of living beings beyond their natural limit.
    </p>
  </div>
</div>
